...
package runTimeConfiguration.publicAccess.typed
...
private object ValLoggerTest {
  implicit val (logger: Logger, formatter, appender) = com.dongxiguo.zeroLog.runTime.RunTimeZeroLoggerFactory.newLogger(this)
  import formatter._
