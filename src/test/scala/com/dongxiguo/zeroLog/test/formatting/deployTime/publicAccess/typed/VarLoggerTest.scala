...
private object VarLoggerTest {
  var logger: Logger = com.dongxiguo.zeroLog.deployTime.ReflectiveZeroLoggerFactory.newLogger(this)._1
  val formatter = com.dongxiguo.zeroLog.deployTime.ReflectiveZeroLoggerFactory.newLogger(this)._2
  import formatter._
