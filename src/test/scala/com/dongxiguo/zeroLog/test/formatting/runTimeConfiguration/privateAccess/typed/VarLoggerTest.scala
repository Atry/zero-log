...
private object VarLoggerTest {
  private var logger: Logger = com.dongxiguo.zeroLog.runTime.RunTimeZeroLoggerFactory.newLogger(this)._1
  private implicit val (_, formatter, appender) = com.dongxiguo.zeroLog.runTime.RunTimeZeroLoggerFactory.newLogger(this)
  import formatter._
