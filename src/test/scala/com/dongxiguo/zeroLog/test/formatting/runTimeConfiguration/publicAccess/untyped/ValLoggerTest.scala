...
package runTimeConfiguration.publicAccess.untyped
...
private object ValLoggerTest {
  implicit val (logger, formatter, appender) = com.dongxiguo.zeroLog.runTime.RunTimeZeroLoggerFactory.newLogger(this)
  import formatter._
