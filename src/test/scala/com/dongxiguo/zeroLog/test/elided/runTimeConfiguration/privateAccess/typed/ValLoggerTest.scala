...
package runTimeConfiguration.privateAccess.typed
...
import Assert._
private object ValLoggerTest {
  implicit private val (logger: Logger, formatter, appender) = com.dongxiguo.zeroLog.runTime.RunTimeZeroLoggerFactory.newLogger(this)
  import formatter._
...
class ValLoggerTest {
  ...
  @Test
  def test = {
    print("zero-log spends "); print(0 until 5 map { ValLoggerTest.doTest(math.random, _) } min); println(" nanoseconds per log.")
  }
